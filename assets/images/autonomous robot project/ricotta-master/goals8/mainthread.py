    ...
    try:
        while True:
            ...
            if cmd == "quit":
                ...
                navigating_to_goal = False
                invalid_goal_reported = False
            elif cmd == "directed_explore" and goal:
                exploring = False
                directed_exploring = True
                paused = False
                navigating_to_goal = False
                invalid_goal_reported = False
                print(f"Starting directed exploration toward goal ({goal[0]}, {goal[1]})")
            elif cmd == "pause":
                paused = True
            elif cmd == "resume":
                paused = False
            ...
            if not paused:
                ...
                elif directed_exploring and goal:
